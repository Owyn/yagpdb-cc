...
**Q: What is sticky message 3?**  
A: Sticky message 3 is an advanced version of the sticky message I added to the YAGPDB Community & Support server. It makes it easier for us volunteers to for example announce to users in several channels that the bot is having issues. It works the same as the [other sticky message](../v1/sticky_message.yag) I have coded but with this version you can:

**Q: Changes since v2?**  
A: v2 had just one global sticky message for ALL channels, v3 is per-channel with separate messages for each channel, separate on\off for each channel, less system messages clutter
